...
<nav class="bg-white shadow-xl dark:bg-emerald-600 fixed w-full z-20 top-0 left-0">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-emerald-600 text-lg  font-bold">
      ...
      <li>
        <a href="{{ route('profile') }}" class="{{ request()->is('profile') ? 'active-link' : '' }} block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 md:dark:hover:text-emerald-300 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Profile</a>
      </li>
      <li>
      ...
      <li>
        <a href="{{ route('leaderboard') }}" class="{{ request()->is('leaderboard') ? 'active-link' : '' }} block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:p-0 md:dark:hover:text-emerald-300 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Leaderboard</a>
      </li>
    </ul>
  </div>
  </div>
